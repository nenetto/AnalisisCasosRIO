...
% partir de toda la información recogida en la carpeta "Codigo" de cada caso
% RIO realizado. Las operaciones que realiza son las siguientes
% 
% 1. Extrae un mapa de TRE para el registro realizado mediante líneas. Usa la
% imagen de máscara de las líneas para calcular la componente espacial de la 
% fórmula empleada por Fitzpatrick.
% 
% 2. Extrae un mapa de TRE para el registro realizado mediante puntos. Usa la
% imagen de máscara de los puntos para calcular la componente espacial de la 
% fórmula empleada por Fitzpatrick.
% 
% 
% 3. Extrae un mapa de TRE evaluar la componente/deriva espacial en cada eje 
% principal para el registro por líneas.
% 
% 4. Calcula el FRE de las líneas
% 
% 5. Calcula el FRE de los puntos
% 
% 6. Crea nuevos mapas que multiplican FRE por el mapa de componente espacial
% TRE antes extraído para cada caso: líneas o puntos
% 
% 7. Crea una bola donde calcula el error para las líneas y extrae la media y
...
TRE_ejes_200 = mean(errores);
TRE_ejes_200_sd = sd(errores);
...
%% TRE puntos con el registro de las líneas (Opción V)
...
results.frelines = FRELineas;
results.frepoints = FREPuntos;
results.tre_ejes_principales = tre_ejes_principales;
results.TRE_ejes_200.mean = TRE_ejes_200;
results.TRE_ejes_200.sd = TRE_ejes_200_sd;
results.tre_puntosUsingM_lines = tre_puntosUsingM_lines;
...
save(str_aux,'FREPuntos','-ascii', '-double')
...
str_aux = [folder, 'Resultados/Results'];
save(str_aux,'results');
